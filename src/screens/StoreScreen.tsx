    ...
    <SafeAreaView className="flex-1 bg-slate-50">
      <View className="flex-1 px-5 pt-8">
        ...
        <View className="mt-7 items-center rounded-3xl bg-white p-6">
          ...
          <Text className="mt-4 text-xl font-bold text-slate-900">Ricksan</Text>
          ...
          <View className="mt-6 flex-row">
            <View className="items-center px-6">
              ...
              <Text className="text-xs text-slate-400">Project</Text>
            </View>

            <View className="items-center border-l border-slate-200 px-6">
              <Text className="text-xl font-bold text-blue-600">24</Text>

              <Text className="text-xs text-slate-400">Task</Text>
            </View>
          </View>
        </View>
